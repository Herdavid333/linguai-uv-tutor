export default function AuthCard({
  ...
  return (
    <div
      className="w-full rounded-[10px] border-2 border-[#f3a3a3] bg-white shadow-sm overflow-hidden"
      ...
      <div className="relative bg-[#b8b8b8] h-[100px] sm:h-[120px] md:h-[150px] flex flex-col items-center justify-center">
        ...
        {showArrow && (
          <div className="absolute left-1/2 -translate-x-1/2 bottom-[-16px] md:bottom-[-20px]">
            <div className="w-0 h-0 border-l-[14px] border-r-[14px] border-t-[16px] md:border-l-[20px] md:border-r-[20px] md:border-t-[20px] border-l-transparent border-r-transparent border-t-[#8e8e8e]" />
          </div>
        )}
      </div>
